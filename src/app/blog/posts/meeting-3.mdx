...
It began with the reason of owkring on this topic, to the details of the plan to implement it. 
...
FPGA board available in our labs at university, I will not be able to demonstrate the implementation effiiently. 
So I resumed my search for a more suitable idea. 
