...
I checked SUMO and came across another simulator that claimed to be much faster, so I noted it down in case I incorporate traffic simulation: [CityFlow] (https://cityflow.readthedocs.io/en/latest/start.html).
