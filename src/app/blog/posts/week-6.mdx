...
The whole experiment is simulated in an open-source software called SUMO, Simulation for Urban Mobility.  It reminded me of last year's very successful carpooling solution developed by our seniors. 
...
I went on the open data website provided by the government of the UAE, Bayanat, but did not find the type of data required. I has mostly accident data, with just year & Emirate fields. A few had coordinates, but I needed traffic flow at different points of a road. Site - [Bayanat](https://bayanat.ae/en/).
